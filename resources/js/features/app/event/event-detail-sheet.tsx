...
export default function EventDetailSheet({ data }: EventDetailProps) {
    ...
    useEffect(() => {
        if (!isDragging) return;
        const move = (e: TouchEvent) => onDragMove(e.touches[0].clientY);
        const up = () => onDragEnd();
                ...
                <div className="space-y-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium">
                                ...
                                {data.start_date !== data.end_date && (
                                    <> &ndash; {formatSimpleDate(data.end_date)}</>
                                )}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium">
                                {formatTime12h(data.start_time)} &ndash; {formatTime12h(data.end_time)}
                            </p>
                        </div>
                    </div>
                </div>
