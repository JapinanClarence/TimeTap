            ...
            <Container className="xl:px-8 mt-5">
                ...
                <div className=" flex flex-col md:flex-row gap-5">
                    <div
                        ref={downloadRef}
                        id="qr-download-area"
                        className=" rounded-2xl overflow-clip animate-fade-up bg-white shadow-sm border-slate-200 hover-card md:w-100 md:min-w-100"
                    >
                        {/* Header Section */}
                    ...
                    <div className="hidden md:flex space-y-5 animate-fade-up">
                        ...
                        <div className="border border-primary p-5 rounded-xl bg-primary/10 text-primary shadow-sm">
                            <h4 className="font-bold text-xl">How to use?</h4>
                            <p className="text-sm text-muted-foreground">
                                Lorem ipsum dolor, sit amet consectetur
                                adipisicing elit. Est quae tempore ab molestias
                                consequatur enim{" "}
                            </p>
                        </div>
                    </div>
